...
- Formation error plots use a large `30cm x 18cm` layout (height:width = 3:5), Times New Roman 8pt labels, open L-shaped axes, no title/grid, high-contrast color+line+marker curves, fixed `0-50m` y-axis range, and PDF/EPS vector export.
