...
- Formation error plots use a large `30cm x 10cm` layout (height:width = 1:3), Times New Roman labels, open L-shaped axes, no in-plot title/grid, high-contrast color+line+marker curves, a bold black solid mean line, fixed `0-50m` y-axis range with ticks at `0,10,20,30,40,50`, and PDF/EPS vector export.
