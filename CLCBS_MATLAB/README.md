...
- Formation error plots use a paper-style layout: 8.5cm x 6cm figure size, Times New Roman 8pt labels, open L-shaped axes, no title/grid, high-contrast color+line+marker curves, fixed `0-50m` y-axis range, and PDF/EPS vector export.
